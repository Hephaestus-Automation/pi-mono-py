...
def stream_openrouter(
    ...
    """Stream from OpenRouter API (OpenAI-compatible gateway)."""
    ...
    async def _run():
        ...
        try:
            ...
            headers = {
                ...
                "HTTP-Referer": "https://github.com/pi-mono-py",  # Optional, for rankings
                "X-Title": "pi-mono-py",  # Optional, for rankings
            }
