...
def register_zhipu_models(base_url: str = "https://open.bigmodel.cn/api/paas/v4") -> None:
    zhipu_models = [
        Model(
            ...
            reasoning=False,
            input=["text", "image"],
            cost=ModelCost(input=0.05, output=0.05, cache_read=0, cache_write=0),
            context_window=128000,
            max_tokens=4096,
        ),
        Model(
        ...
        Model(
            ...
            reasoning=False,
            input=["text"],
            cost=ModelCost(input=0.001, output=0.001, cache_read=0, cache_write=0),
            context_window=128000,
            max_tokens=4096,
        ),
        Model(
        ...
        Model(
            ...
            reasoning=False,
            input=["text", "image"],
            cost=ModelCost(input=0.0001, output=0.0001, cache_read=0, cache_write=0),
            context_window=128000,
            max_tokens=4096,
        ),
        Model(
        ...
        Model(
            ...
            reasoning=False,
            input=["text", "image"],
            cost=ModelCost(input=0.01, output=0.01, cache_read=0, cache_write=0),
            context_window=8000,
            max_tokens=1024,
        ),
        Model(
